...
const secretShadow = new CreatureCard(
    'SECRET SHADOW',
    new Cost(10, 8, 11),
    4
)

const grumpyTroll = new CreatureCard(
    'GRUMPY TROLL',
    new Cost(9, 11, 9),
    4
)

const gooeyGlob = new CreatureCard(
    'GOOEY GLOB',
    new Cost(14, 9, 10),
    5
)

const angryOgre = new CreatureCard(
    'ANGRY OGRE',
    new Cost(12, 9, 14),
    5
)

const blueDragon = new CreatureCard(
    'BLUE DRAGON',
    new Cost(13, 10, 13),
    6
)

const orangeDragon = new CreatureCard(
    'ORANGE DRAGON',
    new Cost(15, 11, 12),
    7
)

export const CreatureCards: Array<DragonWoodCard> = [
    ...spookySpiders,
    ...crazyBats,
    ...gigglingGoblin,
    ...fireAnts,
